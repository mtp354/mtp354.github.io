...
excerpt: "This project was made possible thanks to the [Quantum Open Source Foundation](https://qosf.org/) and their mentorship programme. I'm tremendously grateful to my mentor Dr. Chen for all of the support, and for dreaming up the original project idea. This was my first foray into distributed quantum computing and cryptography, and it has shaped my research interests ever since."
date: 2025-05-15
venue: 'IEEE QCNC'
paperurl: '/files/byzantine.pdf'
bibtexurl: '/files/byzantine.bib'
plain_summary: "Plain-language summary (draft — please review). When several quantum computers try to agree on a single answer, a few faulty or malicious machines can in principle derail the whole group — the classical 'Byzantine Generals' problem, but quantum. We layered two off-the-shelf noise-fighting tricks (readout error mitigation and dynamical decoupling) on top of an existing quantum-agreement protocol and ran it on real IBM hardware. The combination noticeably improves how often the honest machines reach the right consensus, even on today's noisy devices."
---
