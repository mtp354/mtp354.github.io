...
slidesurl: '/files/pole_cea.pdf'
paperurl: '/files/pole_cea.pdf'
plain_summary: "Plain-language summary (draft — please review). Endometrial (uterine-lining) cancer comes in several genetic flavors, and one of them — POLE-mutated — has a much better outlook than the others. We modelled whether testing for that mutation, then sparing those patients from extra radiation, is worth the extra lab cost. It turns out it is: the test pays for itself by avoiding unnecessary treatment."
---
