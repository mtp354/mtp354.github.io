...
paperurl: '/files/non_demolition.pdf'
bibtexurl: '/files/non_demolition.bib'
plain_summary: "Plain-language summary (draft — please review). Two clouds of cold atoms can be made to share quantum-mechanical correlations (entanglement) by gently 'measuring' them with light without destroying the state. We worked out, with pen-and-paper math and Mathematica, how much of that entanglement survives the unavoidable noise from stray photons and atomic jitter — and showed the entanglement is robust enough that the technique remains one of the most promising recipes for entangling matter."
---
