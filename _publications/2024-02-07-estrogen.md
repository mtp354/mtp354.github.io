...
excerpt: 'I really enjoyed working with my co-authors on this project. It was a great opportunity to use Bayesian methods on a policy-focused question. Reading someone else''s model closely feels like a window into how they think, and it definitely makes me reflect on code I have written in the past. Learning is thankfully a lifelong pursuit, and this project helped improve my coding.'
date: 2024-02-07
venue: 'American Journal of Obstetrics and Gynecology'
paperurl: '/files/estrogen.pdf'
bibtexurl: '/files/estrogen.bib'
plain_summary: "Plain-language summary (draft — please review). When younger women have their ovaries surgically removed, clinical guidelines say they should usually take estrogen replacement therapy until natural-menopause age. Many do not. We modelled the downstream consequences over 25 years and found this gap is associated with hundreds of avoidable cases of heart disease, stroke, and breast-cancer death — far more harm than the relatively small reduction in colorectal cancer."
---
Background
